//This file is copied from com.unity.shadergraph/Editor/Generation/Targets/BuiltIn/ShaderLibrary/Core.hlsl
//(removed the #include lines to other ShaderGraph hlsl)
